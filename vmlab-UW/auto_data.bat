...
for %%i in (%numArr%) do (
    ...
    extractpatch.py !cthistpath! 444428.yml patch_mask8\hist0_75big\hist%%i list\mask8\hist0_75big\histID%%i.txt --mask !mask_path!
)
